...
# Description: Wrapper class to get cameras and filepaths set up for calibration sequence.
# After calibration is complete, cleans up unnecessary camera objects to prevent misassignment later.
