...
class ledController(QtGui.QMainWindow, opto_class):
    ...
    def __init__(self, parent=None):
        ...
        self.cycles = 2         # Number of cycles to repeat pulse during pulse trains
        ...
        # make Qt window
        super(ledController, self).__init__(parent)
        self.setupUi(self)
        self.setWindowTitle('Waveform Builder')

        # get waveform functions and add them to checkbox
        funcs = inspect.getmembers(ledController, predicate=inspect.ismethod)
