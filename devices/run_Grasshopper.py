...
class runGrasshopper:
    ...
    def __init__(self, mode, **kwargs):
        ...
        # make this dependent on the animal. May need to be tweaked from animal to animal
        # add animals as needed
        ...
        # so units used for above variables are valid
        ...
        if self.save:
            ...
            if not self.only_roi:
                ...
                self.video = cv2.VideoWriter(self.vidPath, fourcc, self.framerate, (self.ROI[1][0]-self.ROI[0][0], self.ROI[1][1] - self.ROI[0][1]),
                                             False)

    def set_feature(self, prop, **kwargs):
        """Takes property name and value to set"""
...
if __name__ == '__main__':
    ...
    gh = runGrasshopper(mode, roi=verticesROI, animalName='Dummy', framerate=60, vidPath=vidPath, output_queue=im_q, only_roi=False)
