...
CenterOrientations=90
CenterOrientations=CenterOrientations-90
orientations = numpy.arange(0.0,1,float(8)/numOrientations) #Remember, ranges in Python do NOT include the final value!
...
stimDuration = 3#stimulus duration in seconds; will be adjusted if adjustDurationToMatch2P=1
...
centerPoint = [63.5,0]#[64,8]  # [63.5,0]#[50,-8]  #12
centerPoint1 = [-37.5,0]#[-38,-8]  # [-37.5,0]#[-50,8]
#centerPoint1 = [150,-25] 
#centerPoint = [70,-12]  #for 135
#centerPoint1 = [-30,32]
...
stimSize = [100] #Size of grating in degrees  20
surroundSize = 200;
...
for trial in range(0,numTrials): 
    ...
    for stimNumber in stimOrder:
        ...
        if stimNumber == len(orientations):
            ...
            startingPhase1 = orientations[stimNumber]
