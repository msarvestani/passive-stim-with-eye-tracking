...
#orientations=[135, 137.5,140,142.5,145]

#orientations=[130, 140,150,160,170]
#orientations=[40,50,60,70,80]
#orientations=[90,92.5,95,97.5,100]
#orientations=[20,22.5,25,27.5,30]
#orientations=[60,65,70,75,80]
#orientations=[10,20,30,40,50]
#orientations=[70,72.5,75,77.5,80]
...
#gratingStim.setColor([0.1,0.2,0.8], colorSpace='lms')#blue yellow
#gratingStim.setColor([-1,-1,1], colorSpace='rgb')#blue yellow
