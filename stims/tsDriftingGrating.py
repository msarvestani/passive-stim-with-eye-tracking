...
mon= monitors.Monitor('madineh') #gets the calibration for stim
mon.setCurrent('calib_gamma_spectrophotometer')#set calibration
mon.setDistance(25)

# ---------- Stimulus Parameters ---------- #
animalID = 'Baby'                                   # MAKE SURE TO REPLACE THIS WITH CORRECT ANIMAL
#trials and duration
numOrientations = 8#16 #typically 4, 8, or 16
...
serialPortName = 'COM20' # ignored if triggerType is "None"
